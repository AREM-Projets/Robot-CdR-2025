...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12|reset_shield_2_Pin|reset_shield_1_Pin|GPIO_PIN_9, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_12|reset_shield_2_Pin|reset_shield_1_Pin|GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
