...
int main(int argc, const char * argv[]) {
    ...
    id_fifo = open("/home/cdr/Robot-CdR-2025/Code/Raspi/fifo_lidar_to_raspi", O_WRONLY) ;
        ...
        if (SL_IS_OK(op_result)) {
            ...
            for (int pos = 0; pos < (int)count ; ++pos) {
                ...
                if (nodes[pos].quality >> SL_LIDAR_RESP_MEASUREMENT_QUALITY_SHIFT > 30){
                    sprintf(message, "%ld %3.2f %8.2f \n", sec , (nodes[pos].angle_z_q14 * 90.f)/ 16384.f , nodes[pos].dist_mm_q2/4.0f);
                    write(id_fifo, message, sizeof(message));
                }
